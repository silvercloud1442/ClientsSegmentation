...
- Оптимальное число кластеров определено через **метод локтя** (**4 кластера**).
  <p><img src="imgs/k_elbow.jpg" width=500></p>  
- Использована **агломеративная кластеризация (AgglomerativeClustering)**.  
  <p><img src="imgs/cluster_distribution.jpg" width=500></p>  


### 4. Анализ кластеров

  Для наглядного понимания различий между кластерами представлены два ключевых графика:
  - <p><img src="imgs/cluster_info.jpg" width=500></p>  

  - **Три графика**, отображающих количество клиентов, их общие расходы и средние траты на одного клиента по каждому кластеру. Это позволяет увидеть значимость каждого кластера и его покупательскую способность.
   - <p><img src="imgs/cluster_heatmap.jpeg" width=500></p>

   - **Корреляционная матрица**, показывающая связи между различными переменными внутри кластеров. Позволяет понять ключевые факторы различия кластеров.

Основыне характеристики кластеров:
- **Кластер 0**: Клиенты с средним доходом, активно совершающие покупки в интернете и участвующие в акциях. Они проявляют интерес к скидкам и регулярно посещают сайт.  
